let mongoose,Schema,bcrypt,jwt;_509‍.x([["default",()=>_509‍.o]]);_509‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}],["Schema",["Schema"],function(v){Schema=v}]]);_509‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_509‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);/*define UserSchema and [static] methods to store user infomation in mongoDB.*/
