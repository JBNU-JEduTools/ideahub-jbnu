let Content,mongoose,Joi,sanitizeHtml;_ecb‍.x([["checkObjectId",()=>checkObjectId],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["updateComment",()=>updateComment],["update",()=>update]]);_ecb‍.w("../../models/content",[["default",["Content"],function(v){Content=v}]]);_ecb‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_ecb‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_ecb‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);//ContentSchema를 이용해 만든 Content 모델 객체 불러옴.
