let Post,mongoose,Joi,sanitizeHtml;_4a8‍.x([["getPostById",()=>getPostById],["checkOwnPost",()=>checkOwnPost],["write",()=>write],["list",()=>list],["listRecommendedPosts",()=>listRecommendedPosts],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_4a8‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_4a8‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_4a8‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_4a8‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);/*controlls posting middleware functions*/
...
const removeHtmlAndShorten = (body) => {
  ...
  try {
    ...
    ctx.throw(500, e);
       ...
       const listRecommendedPosts = async (ctx) => {
  try {
