let Content,mongoose,Joi,sanitizeHtml;_4d2‍.x([["checkObjectId",()=>checkObjectId],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["updateComment",()=>updateComment],["update",()=>update]]);_4d2‍.w("../../models/content",[["default",["Content"],function(v){Content=v}]]);_4d2‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_4d2‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_4d2‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);//ContentSchema를 이용해 만든 Content 모델 객체 불러옴.
