let Content,mongoose,Joi,sanitizeHtml;_b6a‍.x([["checkObjectId",()=>checkObjectId],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["updateComment",()=>updateComment],["update",()=>update]]);_b6a‍.w("../../models/content",[["default",["Content"],function(v){Content=v}]]);_b6a‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_b6a‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_b6a‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);//ContentSchema를 이용해 만든 Content 모델 객체 불러옴.
